...
<script>
import createUserpart1 from "@/components/accountSettings/createUserFormPersonal";
import createUserpart2 from "@/components/accountSettings/createUserFormInstitucional";
